...
class BookmarksAPISimulation extends Simulation {
  ...
  setUp(
      ...
      scnGetBookmarksByUser.inject(rampUsers(200) during (10 seconds)),
      scnGetBookmarkById.inject(rampUsers(100) during (10 seconds)),
      scnCreateBookmark.inject(rampUsers(100) during (10 seconds))
  ).protocols(httpConf)
